...
package org.tensorflow.env.tracking;
...
import org.tensorflow.env.Size;
...
public class ObjectTracker {
  ...
  static {
    try {
      System.loadLibrary("tensorflow_env");
      libraryFound = true;
    } catch (UnsatisfiedLinkError e) {
      LOGGER.e("libtensorflow_env.so not found, tracking unavailable");
    }
  }
